...
console.log((0, _randomWords2.default)({ exactly: 1, maxLength: 4 }));
...
var gameFunction = function gameFunction() {
    var word = 0;
    var url = 'https://random-word-api.herokuapp.com/word?length=5&lang=es'; // will return one random word.
