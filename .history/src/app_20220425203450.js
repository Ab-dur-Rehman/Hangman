    ...
    matchWord (el) {
        ...
        if (letter_index.length > 0) {
            ...
            if (this.count == ind_letters.length) {
                ...
                //document.getElementById("keypad").innerHTML = '<p>Congratulations You win</p><div id="startGame_button" onClick={gameFunction}>Play Again</div>';
                let appKeypad2 = document.getElementById("keypad");
                ReactDOM.render(restart_game, appKeypad2);
            }
        } else {
            if ((this.letterPool.indexOf(selected_letter) == -1) && (this.letterPool.length < 6)) {
                ...
                //document.getElementById("keypad").innerHTML = '<div id="startGame_button" onClick='+{gameFunction} +'>Play Again</div><p>Sorry! You Lost</p>';
...
let restartGame = document.getElementById("keypad");
