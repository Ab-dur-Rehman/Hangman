    ...
    matchWord (el) {
        ...
        if (letter_index.length > 0) {
            ...
            if (this.count == ind_letters.length) {
                ...
                //document.getElementById("keypad").innerHTML = "Congratulations You win";
                //document.getElementById("keypad").innerHTML = {game_hangman};
                document.getElementById("keypad").innerHTML = <div id="startGame_button" onClick={gameFunction}>Let's Play</div>;
            }
        } else {
            if ((this.letterPool.indexOf(selected_letter) == -1) && (this.letterPool.length < 6)) {
                ...
                document.getElementById("keypad").innerHTML = "You Lost";
