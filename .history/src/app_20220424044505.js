...
const gameKeypad = {
    ...
    matchWord (el) {
        ...
        if (letter_index.length > 0) {
            ...
            if ((this.letterPool.indexOf(selected_letter) == -1) && (this.letterPool.length < 7)) {
                ...
                //document.getElementsByClassName("alphaButtons").disabled = true;
                alert('you lost');
                document.getElementById("keypad").innerHTML = "";
                let word_display = document.getElementsByClassName("letter_box");
                word_display.style.opacity = "1";
            }
        }
