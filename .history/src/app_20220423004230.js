...
const gameKeypad = {
    ...
    //generateKeyPad(test) {
        ...
        // const content = letters.map(
        //     (letter) => `<button type="button" class="btn btn-secondary letter-button" value="${letter}">${letter}</button>`
        //     );
...
ReactDOM.render(gameKeypad, appKeypad);
